                ...
                <div className="crgm-movie-card">
                    ...
                    <div className='crgm-movie-card-details'>
                        ...
                        <p>When Death personified visits Earth in the body of a young man named Joe Black,
                            ...
                            The film explores the mystery of existence, the power of love, and the inevitability of parting.
                        </p>
                        <div className='crgm-genres-category'>
                            <GenreCategory name='Drama' />
                            <GenreCategory name='Romance' />
                            <GenreCategory name='Action' />
                        </div>
                    </div>
                </div>
            </div>
